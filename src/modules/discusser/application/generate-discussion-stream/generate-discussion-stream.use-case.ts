...
import { GenerateDiscussionStreamDto } from './generate-discussion-stream.dto';

export class GenerateDiscussionStream {
  constructor(private readonly completionRepository: CompletionRepository) {}
  async execute(payload: GenerateDiscussionStreamDto) {
